...
export const PricingCard = ({ name, price, period, features, cta, lang, CONFIG, formatPrice, onSelect, popular = false }) => (
  <Card
    CONFIG={CONFIG}
  ...
  >
    <div className="flex flex-col h-full">
      {popular && (
        <div className="mb-4 inline-flex self-start items-center gap-1.5 rounded-full bg-yellow-400/15 border border-yellow-400/30 px-3 py-1 text-xs font-semibold text-yellow-300 tracking-wide">
